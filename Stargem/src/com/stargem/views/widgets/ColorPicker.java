 ...
 * ColorPicker.java
 * 
 * Written by Titoasty. See http://www.badlogicgames.com/forum/viewtopic.php?f=17&t=12089&start=10
 *
 * @author 	Titoasty
 * @date	14 Jan 2014
 * @version	1.0
	...
	public ColorPicker(Skin skin) {
		...
		brightness.addListener(new DragListener() {
			...
			public void drag(InputEvent event, float x, float y, int pointer) {
				...
				luminancePicked = (BRIGHTNESS_HEIGHT - y) / BRIGHTNESS_HEIGHT;
		...
		brightness.addListener(new InputListener() {
			@Override
			public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
				luminancePicked = y / BRIGHTNESS_HEIGHT;
