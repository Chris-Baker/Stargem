...
public class SkyRepresentation extends AbstractIterableRepresentation {
	...
	private void build(SkySphere sky, Texture texture_1, Texture texture_2, Texture texture_3, Texture texture_4, Texture texture_5, Texture texture_6) {
		...
		materials[0] = new Material(TextureAttribute.createDiffuse(texture_1), new DepthTestAttribute(0, false));
		materials[1] = new Material(TextureAttribute.createDiffuse(texture_2), new DepthTestAttribute(0, false));
		materials[2] = new Material(TextureAttribute.createDiffuse(texture_3), new DepthTestAttribute(0, false));
		materials[3] = new Material(TextureAttribute.createDiffuse(texture_4), new DepthTestAttribute(0, false));
		materials[4] = new Material(TextureAttribute.createDiffuse(texture_5), new DepthTestAttribute(0, false));
		materials[5] = new Material(TextureAttribute.createDiffuse(texture_6), new DepthTestAttribute(0, false));
		...
		for (int orientation = 0; orientation < SkySphere.NUM_FACES; orientation += 1) {
			...
			QuadSphereSegment segment = segments[orientation][0][0];
